...
class Ui_MainWindow(object):
    ...
    def crear_base(self):
        cursor = conn.cursor()
        cadena_sql = 'CREATE TABLE Empleado (nombre TEXT, sueldo INTEGER, pago_iva FLOAT, pago_final FLOAT)'
        try:
    ...
    def guardar_informacion(self):
        ...
        iva = sueldo*0.12
        sueldo_final = sueldo + iva
        cadena_sql = """INSERT INTO Empleado (nombre, sueldo, pago_iva, pago_final) VALUES ('%s', %d, %s, %s);""" % \
    (nombre, sueldo, iva, sueldo_final)
        # ejecutar el SQL
        cursor.execute(cadena_sql)
